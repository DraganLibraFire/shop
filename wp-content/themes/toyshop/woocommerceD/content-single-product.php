	...
	<div class="summary entry-summary">
		...
		<div class="share-buttons clearfix">
			...
			<div class="share-links-wrapper pull-right">
				...
				<!-- Pinterest -->
				<a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>]&description=<?php the_title(); ?>" class="btn btn-pinterest" target="_blank" title="Share on Pinterest"><i class="fa fa-pinterest-p transition-all-05"></i></a>
