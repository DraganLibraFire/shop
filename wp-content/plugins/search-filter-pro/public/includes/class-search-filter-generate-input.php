	...
	public function checkbox($args)
	{
		...
		<ul<?php echo $attibutes_html; ?>>
			...
			for($i=0; $i<$option_count; $i++)
			{
				...
				$option_label = ucfirst(trim(str_replace("-", " ", $option_label)));

				echo '<li class="'.$option_class.'"'.$container_attibutes_html.'><label class="sf-label-checkbox" for="'.$input_id.'"><input '.$input_attibutes_html.'><span class="search-check"><i class="fa fa-square-o" aria-hidden="true"></i></span>'.$option_label.'</label>';
