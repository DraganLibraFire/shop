jQuery(function($){
    ...
    $('body').on('click', '.dropdown-cart-button .dropdown-total, .widget_shopping_mini_cart', function($e){
        ...
        if(!$popup.is(':visible')){
            ...
            $(".widget_shopping_mini_cart").addClass('active');
            $popup.slideDown();
        }else{
            $popup.slideUp();
            $(".widget_shopping_mini_cart").removeClass('active');
        }
    ...
    $(document).on('click', function(){
        $('.dropdown-cart-button .dropdown').slideUp();
        $(".widget_shopping_mini_cart").removeClass('active');
    });
