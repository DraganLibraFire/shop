	...
	function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 )
	{
		...
		else if(($this->type=="checkbox")||($this->type=="radio"))
		{
			...
			//{
				...
				$link .= "<label><input type='".$this->type."' name='".$sf_name."[]' value='".$cat_slug."'".$checked.$disabled." data-sf-cr='".SF_TAX_PRE.$cat_id."' data-sf-hide-empty='".intval($hide_empty)."' /> <span class=\"search-check\"><i class=\"fa fa-square-o\" aria-hidden=\"true\"></i></span>".$cat_name;
