		...
		$settings = array_merge(
			array(
				...
				array(
					...
					'desc'      => apply_filters( 'alg_wc_custom_order_numbers', sprintf( 'You will need <a href="%s" target="_blank">Custom Order Numbers for WooCommerce Pro</a> plugin to set this option.', 'https://wpcodefactory.com/item/custom-order-numbers-woocommerce/' ), 'settings' ),
				...
				array(
					...
					'desc'      => __( 'Enable', 'custom-order-numbers-for-woocommerce' ),
					'desc_tip'  => __( 'This will add "Order Number" meta box to each order\'s edit page. "Order Numbers Counter" must be set to "Sequential".', 'custom-order-numbers-for-woocommerce' ) . '<br>' .
						apply_filters( 'alg_wc_custom_order_numbers', sprintf( 'You will need <a href="%s" target="_blank">Custom Order Numbers for WooCommerce Pro</a> plugin to set this option.', 'https://wpcodefactory.com/item/custom-order-numbers-woocommerce/' ), 'settings' ),
